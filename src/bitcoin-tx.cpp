...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s educacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  educacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded educacoin transaction") + "\n" +
              "  educacoin-tx [options] -create [commands]   " + _("Create hex-encoded educacoin transaction") + "\n" +
              "\n";
